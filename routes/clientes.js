...
router.patch('/:ClienteId', async (req,res) => {
    try {        
        const updatedCliente = await Cliente.updateOne(
            ...
            { $set: { codigoCliente: req.body.codigoCliente} },
            { $set: { fechaIngreso: req.body.fechaIngreso} },
            { $set: { cedulaIdentidad: req.body.cedulaIdentidad} },
            { $set: { primerApellido: req.body.primerApellido} },
            { $set: { segundoApellido: req.body.segundoApellido} },
